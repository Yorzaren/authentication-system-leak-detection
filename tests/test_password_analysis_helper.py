...
class TestPasswordAnalysisHelper:
    ...
    def test_starts_with_uppercase_letter(self):
        ...
        assert (
            password_analysis_helper.starts_with_uppercase_letter("123sdasds") is False
        )
        assert (
            password_analysis_helper.starts_with_uppercase_letter("你$asdasds") is False
        )
    ...
    def test_starts_with_lowercase_letter(self):
        ...
        assert (
            password_analysis_helper.starts_with_lowercase_letter("123sdasds") is False
        )
        assert (
            password_analysis_helper.starts_with_lowercase_letter("你$asdasds") is False
        )
    ...
    def test_ends_with_uppercase_letter(self):
        assert (
            password_analysis_helper.ends_with_uppercase_letter("SJRHerisdf") is False
        )
        assert (
            password_analysis_helper.ends_with_uppercase_letter("ajsdfh(213U") is True
        )
        assert password_analysis_helper.ends_with_uppercase_letter("dsfsdf34*") is False
        assert (
            password_analysis_helper.ends_with_uppercase_letter("kljko@sdg1") is False
        )
        assert (
            password_analysis_helper.ends_with_uppercase_letter("sdikfj32(2jJ好")
            is False
        )
    ...
    def test_ends_with_lowercase_letter(self):
        ...
        assert (
            password_analysis_helper.ends_with_lowercase_letter("ajsdfh(213U") is False
        )
        assert password_analysis_helper.ends_with_lowercase_letter("dsfsdf34*") is False
        assert (
            password_analysis_helper.ends_with_lowercase_letter("kljko@sdg1") is False
        )
        assert (
            password_analysis_helper.ends_with_lowercase_letter("sdikfj32(2jJ好")
            is False
        )
