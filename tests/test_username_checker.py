...
class TestUsernameCheckerFunctions:
    def test_is_valid_username(self):
        ...
        assert username_checker.is_valid_username("asdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaa") is True  # Meets the max
        assert username_checker.is_valid_username("asdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaasdaaa") is False  # Max + 1
